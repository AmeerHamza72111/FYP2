      ...
      <Navbar bg="primary" variant="dark" expand="lg">
        <Container>
          ...
          >
            ...
            {userInfo && userInfo.isSeller && (
              <LinkContainer to="/sellerMilestone" variant="primary">
                <Nav.Link>
                  <i className="fas fa-user navbar-icons" /> Seller Milestone
                </Nav.Link>
              </LinkContainer>
            )}
            ...
            {userInfo ? (
              ...
              <>
                ...
                <LinkContainer to="/contactExpert" variant="primary">
                  <Nav.Link>
                    <i className="fas fa-user navbar-icons" /> Contact Expert
                  </Nav.Link>
                </LinkContainer>
              </>
            )}
