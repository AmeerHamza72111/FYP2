...
export const SEND_MAIL_EXPERT_REQUEST = "SEND_MAIL_EXPERT_REQUEST";
export const SEND_MAIL_EXPERT_SUCCESS = "SEND_MAIL_EXPERT_SUCCESS";
export const SEND_MAIL_EXPERT_FAILURE = "SEND_MAIL_EXPERT_FAILURE";
export const SEND_MAIL_EXPERT_RESET = "SEND_MAIL_EXPERT_RESET";

export const SELLER_MILESTONE_REQUEST = "SELLER_MILESTONE_REQUEST";
export const SELLER_MILESTONE_SUCCESS = "SEND_MAIL_EXPERT_SUCCESS";
export const SELLER_MILESTONE_FAILURE = "SELLER_MILESTONE_FAILURE";
export const SELLER_MILESTONE_RESET = "SELLER_MILESTONE_RESET";

export const SELLER_DETAILS_REQUEST = "SELLER_DETAILS_REQUEST";
export const SELLER_DETAILS_SUCCESS = "SELLER_DETAILS_SUCCESS";
export const SELLER_DETAILS_FAILURE = "SELLER_DETAILS_FAILURE";
