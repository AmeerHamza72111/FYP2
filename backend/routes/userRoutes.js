...
// @route PUT & GET /api/users/profile
// @access PRIVATE
router.route("/contact/expert").post(postContactExpert);

// @desc get data for an authenticated user, and update data for an authenticated user
// @route PUT & GET /api/users/profile
// @access PRIVATE
router.route("/milestone").post(postSellerMileStone);
// @desc Get Seller Records from SellerMileStones table
// @route GET /api/users/seller/:id
// @access
router.route("/seller/:id").get(getSellerRecordById);
